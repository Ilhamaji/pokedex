...
export default function Nav({ inputValue, setInputValue, handleSearch }) {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 py-3 flex items-center justify-between gap-2 sm:gap-4">
          ...
          <button
            ...
            className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95 flex-shrink-0 ${
              dark
                ...
                : "bg-white text-indigo-600 shadow-sm border border-slate-200 hover:border-indigo-200 hover:bg-indigo-50"
            }`}
          >
            {dark ? (
              /* Sun icon */
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 animate-glow-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
